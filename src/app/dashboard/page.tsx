...
const mockData = [
  ...
  },
  {
    ...
    description:
      "A secure API for integrating payment processing into web and mobile applications. Supports multiple currencies and payment methods.",
    price: "$50/month",
  ...
  },
  {
    ...
    title: "Location API",
    description:
      "Provides accurate geolocation data including latitude, longitude, and address based on IP or GPS coordinates. Ideal for mapping and navigation apps.",
    price: "$20/month",
    company: "GeoFind",
  ...
  },
  {
    ...
    description:
      "Get real-time stock market data, historical data, and financial information. Supports major global stock exchanges.",
    price: "$30/month",
    company: "StockWatch",
  ...
  },
  {
    ...
    description:
      "Get up-to-date cryptocurrency prices and market data from top exchanges. Supports Bitcoin, Ethereum, and more.",
    price: "$40/month",
    company: "CryptoTrack",
  ...
  },
  {
    ...
    description:
      "Validate email addresses in real-time to ensure deliverability. Helps to prevent fake or mistyped email registrations.",
    price: "$15/month",
    company: "EmailVerify",
  ...
  },
  {
    ...
    description:
      "Send and receive SMS messages worldwide. Supports two-factor authentication, notifications, and promotional messages.",
    price: "$25/month",
    company: "TextPro",
  ...
  },
  {
    ...
    description:
      "Access pre-trained machine learning models for image recognition, natural language processing, and more. Easy-to-use endpoints for ML applications.",
    price: "$100/month",
    company: "AIML Corp",
  ...
  },
  {
    ...
    description:
      "Explore blockchain transactions, addresses, and blocks in real-time. Supports multiple blockchains including Ethereum and Bitcoin.",
    price: "$60/month",
    company: "BlockExplorer",
    type: ["Blockchain", "Exploration", "Data Retrieval"],
    response:
      '{"block_number": "123456", "transactions": ["tx1", "tx2", "tx3"]}',
  ...
  },
  {
    ...
    description:
      "Analyze social media platforms for engagement metrics, audience demographics, and sentiment analysis. Supports Twitter, Facebook, and Instagram.",
    price: "$80/month",
    company: "SocialInsight",
    type: ["Analytics", "Social Media", "Sentiment Analysis"],
    response:
      '{"platform": "Twitter", "mentions": "500", "positive_sentiment": "80%"}',
...
const Marketplace = () => {
  ...
  const uniquePriceRanges = useMemo(() => {
    const prices = mockData.map((item) =>
      parseFloat(item.price.replace("$", "").replace("/month", ""))
    );
  ...
  const filteredData = useMemo(() => {
    return mockData.filter((item) => {
      ...
      const matchesType = selectedType.length
        ? item.type.some((type) => selectedType.includes(type))
        : true;
      const matchesPrice =
        selectedPriceRange === "low"
          ? parseFloat(item.price.replace("$", "").replace("/month", "")) < 20
      ...
      >
        {filteredData.map((item) => (
          <Card key={item.id} shadow="sm" padding="lg" radius="md" withBorder>
            ...
            <Badge color="blue" variant="light" my={8}>
              {item.price}
            </Badge>
